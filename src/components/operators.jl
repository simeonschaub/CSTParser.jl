...
const AllPrecs = Dict("≏" => PlusOp, "⤎" => ArrowOp, "<:" => ComparisonOp, "⫌" => ComparisonOp, "⇀" => 0, "≁" => ComparisonOp, "⧀" => ComparisonOp, "⪎" => ComparisonOp, "⪱" => ComparisonOp, "↬" => 0, "⇝" => 0, "⩳" => ComparisonOp, "⪻" => ComparisonOp, "//" => RationalOp, "⬿" => ArrowOp, "⊅" => ComparisonOp, "⋳" => ComparisonOp, "≮" => ComparisonOp, "\$=" => AssignmentOp, "≗" => ComparisonOp, "⋗" => ComparisonOp, "⩊" => PlusOp, "⪵" => ComparisonOp, "⋟" => ComparisonOp, "⤠" => ArrowOp, "≵" => ComparisonOp, "⧁" => ComparisonOp, "≫" => ComparisonOp, "⩫" => ComparisonOp, "⪸" => ComparisonOp, "⊓" => TimesOp, "⭄" => ArrowOp, "⇁" => 0, "≀" => TimesOp, "⪚" => ComparisonOp, "∷" => ComparisonOp, "⥪" => ArrowOp, "⥔" => PowerOp, "⊻" => PlusOp, "⩯" => ComparisonOp, "↷" => 0, "⇿" => ArrowOp, "⪉" => ComparisonOp, "⊰" => ComparisonOp, "⨟" => 0, "⩻" => ComparisonOp, "⭋" => ArrowOp, "⩒" => PlusOp, "-" => PlusOp, "⫸" => ComparisonOp, "⤒" => PowerOp, "+=" => AssignmentOp, "↦" => ArrowOp, "⊜" => ComparisonOp, "|>" => PipeOp, "⩀" => TimesOp, "⪫" => ComparisonOp, "≡" => ComparisonOp, "⋹" => ComparisonOp, "⤑" => ArrowOp, "⥐" => ArrowOp, "≭" => ComparisonOp, "≼" => ComparisonOp, "⥇" => ArrowOp, "⋶" => ComparisonOp, "⨸" => TimesOp, "⩽" => ComparisonOp, "⪐" => ComparisonOp, "⨥" => PlusOp, "∊" => ComparisonOp, "⪙" => ComparisonOp, "⥢" => ArrowOp, "⅋" => TimesOp, "⫘" => ComparisonOp, "⊂" => ComparisonOp, "⩸" => ComparisonOp, "⩄" => TimesOp, "⤞" => ArrowOp, "⫍" => ComparisonOp, "⨢" => PlusOp, "⊄" => ComparisonOp, "≯" => ComparisonOp, "===" => ComparisonOp, "⬺" => ArrowOp, "⪛" => ComparisonOp, "⋡" => ComparisonOp, "⫀" => ComparisonOp, "⨣" => PlusOp, "↞" => 0, "⟾" => ArrowOp, "⊬" => ComparisonOp, "⇌" => 0, "≷" => ComparisonOp, "∓" => PlusOp, "⪶" => ComparisonOp, "⊀" => ComparisonOp, "⊛" => TimesOp, "⋠" => ComparisonOp, "↢" => 0, "⥦" => ArrowOp, "⪪" => ComparisonOp, "⋌" => TimesOp, "⪅" => ComparisonOp, "≿" => ComparisonOp, ">>=" => AssignmentOp, "\$" => PlusOp, "≽" => ComparisonOp, "⪟" => ComparisonOp, "⋆" => TimesOp, "±" => PlusOp, "⋴" => ComparisonOp, "⥧" => ArrowOp, "/" => TimesOp, "⥕" => PowerOp, "." => DotOp, "⩢" => PlusOp, "⟖" => TimesOp, "⪗" => ComparisonOp, "≓" => ComparisonOp, "⋨" => ComparisonOp, "⥜" => PowerOp, "⪊" => ComparisonOp, "⨽" => TimesOp, "⪦" => ComparisonOp, "≱" => ComparisonOp, "⧷" => TimesOp, ">>" => BitShiftOp, "⊏" => ComparisonOp, "⬴" => ArrowOp, "⪴" => ComparisonOp, "⁝" => ColonOp, "⤘" => ArrowOp, "⩜" => TimesOp, "￬" => PowerOp, "∤" => TimesOp, "⩲" => ComparisonOp, "⫙" => ComparisonOp, "⇵" => PowerOp, "⤗" => ArrowOp, "⪀" => ComparisonOp, "⩬" => ComparisonOp, "↫" => 0, "&" => TimesOp, "⩺" => ComparisonOp, "↚" => ArrowOp, "⨇" => TimesOp, "⋭" => ComparisonOp, "≐" => ComparisonOp, "∩" => TimesOp, "↓" => PowerOp, "⪓" => ComparisonOp, "≦" => ComparisonOp, "=" => AssignmentOp, "∧" => TimesOp, "⇇" => 0, "≖" => ComparisonOp, "⇸" => ArrowOp, "⋙" => ComparisonOp, "≚" => ComparisonOp, "⇴" => ArrowOp, "⬲" => ArrowOp, "⥙" => PowerOp, "⋢" => ComparisonOp, "⫹" => ComparisonOp, "⩛" => PlusOp, "⋿" => ComparisonOp, "⪑" => ComparisonOp, "⭉" => ArrowOp, "⋎" => PlusOp, "⋋" => TimesOp, "⇋" => 0, "≴" => ComparisonOp, "…" => ColonOp, "⪰" => ComparisonOp, "↺" => 0, "⪖" => ComparisonOp, "⨦" => PlusOp, "⬼" => ArrowOp, "⤐" => ArrowOp, "⊗" => TimesOp, "⨮" => PlusOp, "⊚" => TimesOp, "⥈" => ArrowOp, "≣" => ComparisonOp, "⋫" => ComparisonOp, "≺" => ComparisonOp, "⇽" => ArrowOp, "⬳" => ArrowOp, "⥨" => ArrowOp, "⋽" => ComparisonOp, "⩟" => TimesOp, "⋞" => ComparisonOp, "⩖" => PlusOp, "⧥" => ComparisonOp, "⨝" => TimesOp, "⪕" => ComparisonOp, "⊟" => PlusOp, "⋑" => ComparisonOp, "⊲" => ComparisonOp, "≟" => ComparisonOp, "⫈" => ComparisonOp, "⥋" => ArrowOp, "⩂" => PlusOp, "⥏" => PowerOp, "⥩" => ArrowOp, "⥑" => PowerOp, "⪤" => ComparisonOp, "⫖" => ComparisonOp, "×" => TimesOp, "÷=" => AssignmentOp, "⋪" => ComparisonOp, "⫓" => ComparisonOp, "⫄" => ComparisonOp, "⊋" => ComparisonOp, "⇆" => 0, "⤌" => ArrowOp, "⟹" => ArrowOp, "⊖" => PlusOp, "⫏" => ComparisonOp, "⫷" => ComparisonOp, "⪜" => ComparisonOp, "⊕" => PlusOp, "%=" => AssignmentOp, "⊍" => TimesOp, "⨤" => PlusOp, "≃" => ComparisonOp, "⩪" => ComparisonOp, "⤉" => PowerOp, "⪽" => ComparisonOp, "⋓" => PlusOp, "⤀" => ArrowOp, "∺" => ComparisonOp, "⤆" => ArrowOp, "⊳" => ComparisonOp, "//=" => AssignmentOp, "≒" => ComparisonOp, "⩦" => ComparisonOp, "↶" => 0, "⊡" => TimesOp, "⟈" => ComparisonOp, "≩" => ComparisonOp, "||" => LazyOrOp, "↠" => ArrowOp, "⥒" => ArrowOp, "⨧" => PlusOp, "⪧" => ComparisonOp, "⨪" => PlusOp, "⇹" => ArrowOp, "⥛" => ArrowOp, "↣" => ArrowOp, "⫁" => ComparisonOp, "⭊" => ArrowOp, "⋜" => ComparisonOp, "⪳" => ComparisonOp, "⋼" => ComparisonOp, "⥍" => PowerOp, "⫎" => ComparisonOp, "^=" => AssignmentOp, "⪢" => ComparisonOp, "∪" => PlusOp, "⩅" => PlusOp, "⬵" => ArrowOp, "⬽" => ArrowOp, "≬" => ComparisonOp, "⧶" => TimesOp, "⪡" => ComparisonOp, "≶" => ComparisonOp, "⇼" => ArrowOp, "^" => PowerOp, "⇷" => ArrowOp, "⋸" => ComparisonOp, "⊩" => ComparisonOp, "⭀" => ArrowOp, "⧴" => ArrowOp, "⊷" => ComparisonOp, "⤔" => ArrowOp, "~" => AssignmentOp, "⫒" => ComparisonOp, "⩼" => ComparisonOp, "⧺" => PlusOp, "⧻" => PlusOp, ">>>=" => AssignmentOp, "⪂" => ComparisonOp, "⨻" => TimesOp, "⤏" => ArrowOp, "⥘" => PowerOp, "≕" => ComparisonOp, "⥓" => ArrowOp, "⨰" => TimesOp, "⨺" => PlusOp, "⟵" => ArrowOp, "⇜" => 0, "<<=" => AssignmentOp, "≔" => ComparisonOp, "⩋" => TimesOp, "⫊" => ComparisonOp, "⪠" => ComparisonOp, "⥬" => ArrowOp, "⥖" => ArrowOp, "⪣" => ComparisonOp, "↔" => ArrowOp, "≥" => ComparisonOp, "⧤" => ComparisonOp, "⤄" => ArrowOp, "⊢" => ComparisonOp, "⋛" => ComparisonOp, "⩔" => PlusOp, "⇶" => ArrowOp, "⤇" => ArrowOp, "⟽" => ArrowOp, "⩵" => ComparisonOp, "⬶" => ArrowOp, "⩌" => PlusOp, "↮" => ArrowOp, "⪾" => ComparisonOp, "⋕" => ComparisonOp, "⥤" => ArrowOp, "∋" => ComparisonOp, "↽" => 0, "⋇" => TimesOp, "⪍" => ComparisonOp, "⩃" => TimesOp, "⨈" => PlusOp, "⋚" => ComparisonOp, "⩐" => PlusOp, "≾" => ComparisonOp, "⋤" => ComparisonOp, "∔" => PlusOp, "⤈" => PowerOp, "⇾" => ArrowOp, "⊮" => ComparisonOp, "⪩" => ComparisonOp, "⬷" => ArrowOp, "|++|" => PlusOp, "↪" => 0, "⭇" => ArrowOp, "⨨" => PlusOp, "⩓" => TimesOp, "⤊" => PowerOp, "↤" => 0, "⊱" => ComparisonOp, "⟼" => ArrowOp, "⨴" => TimesOp, "⤋" => PowerOp, "⊴" => ComparisonOp, "≊" => ComparisonOp, "⧡" => ComparisonOp, "⫆" => ComparisonOp, "⋯" => ColonOp, "≜" => ComparisonOp, "∍" => ComparisonOp, "::" => DeclarationOp, "⥣" => PowerOp, "⪃" => ComparisonOp, "⪹" => ComparisonOp, "⩴" => ComparisonOp, "⥫" => ArrowOp, "￫" => ArrowOp, ">>>" => BitShiftOp, "≢" => ComparisonOp, "⊈" => ComparisonOp, "≤" => ComparisonOp, "⟿" => ArrowOp, "⪨" => ComparisonOp, "⋖" => ComparisonOp, "⫉" => ComparisonOp, "⩹" => ComparisonOp, "￪" => PowerOp, "⊆" => ComparisonOp, "!==" => ComparisonOp, "⪔" => ComparisonOp, "⥎" => ArrowOp, "≋" => ComparisonOp, "⊁" => ComparisonOp, "⋥" => ComparisonOp, "⋉" => TimesOp, "⨱" => TimesOp, "?" => ConditionalOp, "⥚" => ArrowOp, "⋷" => ComparisonOp, "⟒" => ComparisonOp, "⫅" => ComparisonOp, "⪏" => ComparisonOp, "⩕" => TimesOp, "⪞" => ComparisonOp, ">:" => ComparisonOp, "⟗" => TimesOp, "⪷" => ComparisonOp, "⩎" => TimesOp, "⬱" => ArrowOp, "⇺" => ArrowOp, "⩁" => PlusOp, "⥆" => ArrowOp, "⊘" => TimesOp, "⨼" => TimesOp, "⊙" => TimesOp, "⊇" => ComparisonOp, "⋍" => ComparisonOp, "≛" => ComparisonOp, "⊒" => ComparisonOp, "⋏" => TimesOp, "⭁" => ArrowOp, "⤂" => ArrowOp, "⥄" => ArrowOp, "⋝" => ComparisonOp, "÷" => TimesOp, "⧣" => ComparisonOp, "⊞" => PlusOp, "⬾" => ArrowOp, "⇉" => 0, "⨶" => TimesOp, "in" => ComparisonOp, "==" => ComparisonOp, "⟶" => ArrowOp, "⬰" => ArrowOp, ":=" => AssignmentOp, "⪋" => ComparisonOp, "≂" => PlusOp, "<|" => PipeOp, "⥊" => ArrowOp, "⪺" => ComparisonOp, "≎" => ComparisonOp, "≈" => ComparisonOp, "∌" => ComparisonOp, "⨹" => PlusOp, "⪘" => ComparisonOp, "⨵" => TimesOp, "⦾" => TimesOp, "⇒" => ArrowOp, ".." => ColonOp, "⇛" => 0, "⪿" => ComparisonOp, "≹" => ComparisonOp, "⋱" => ColonOp, "⇎" => ArrowOp, "→" => ArrowOp, "⥮" => PowerOp, "-=" => AssignmentOp, "<" => ComparisonOp, "⪇" => ComparisonOp, "⥗" => ArrowOp, "⪈" => ComparisonOp, "⨫" => PlusOp, "⥞" => ArrowOp, "⭂" => ArrowOp, "⩠" => TimesOp, "\\" => TimesOp, "⩿" => ComparisonOp, "↑" => PowerOp, "≳" => ComparisonOp, "⋧" => ComparisonOp, "⩧" => ComparisonOp, "--" => 0, "⪮" => ComparisonOp, "⪄" => ComparisonOp, "⊎" => PlusOp, "⩾" => ComparisonOp, "↝" => 0, "⨲" => TimesOp, "⊐" => ComparisonOp, "⟻" => ArrowOp, "⫗" => ComparisonOp, "⩞" => TimesOp, "⥯" => PowerOp, "⪌" => ComparisonOp, "≨" => ComparisonOp, "⋄" => TimesOp, "⪯" => ComparisonOp, "⦸" => TimesOp, "⫐" => ComparisonOp, "↜" => 0, "≧" => ComparisonOp, "∉" => ComparisonOp, "⤟" => ArrowOp, "⋾" => ComparisonOp, "￩" => ArrowOp, "<<" => BitShiftOp, "≞" => ComparisonOp, "⩍" => TimesOp, "⇄" => 0, "▷" => TimesOp, "⋘" => ComparisonOp, "≇" => ComparisonOp, "⇏" => ArrowOp, "⊶" => ComparisonOp, "⫇" => ComparisonOp, "*" => TimesOp, "⩣" => PlusOp, "⬸" => ArrowOp, "⥥" => PowerOp, "≙" => ComparisonOp, "*=" => AssignmentOp, "≄" => ComparisonOp, "⊑" => ComparisonOp, "⫑" => ComparisonOp, "⩗" => PlusOp, "⟷" => ArrowOp, "⟱" => PowerOp, "≻" => ComparisonOp, "⋲" => ComparisonOp, "≑" => ComparisonOp, "⭈" => ArrowOp, "∾" => ComparisonOp, "&=" => AssignmentOp, "≪" => ComparisonOp, "\\\\=" => TimesOp, "↼" => 0, "⬹" => ArrowOp, "∗" => TimesOp, "⊣" => ComparisonOp, "⫺" => ComparisonOp, "⥌" => PowerOp, "⋩" => ComparisonOp, "≲" => ComparisonOp, "≝" => ComparisonOp, "⊽" => PlusOp, "/=" => AssignmentOp, "⋬" => ComparisonOp, "⩶" => ComparisonOp, "⫛" => TimesOp, "=>" => ConditionalOp, "⪁" => ComparisonOp, "⨩" => PlusOp, "⥝" => PowerOp, "⩝" => PlusOp, "⟕" => TimesOp, "⤖" => ArrowOp, "⥉" => PowerOp, "⩏" => PlusOp, "!=" => ComparisonOp, "⨳" => TimesOp, "≰" => ComparisonOp, "⟂" => ComparisonOp, "⋐" => ComparisonOp, "\\=" => AssignmentOp, "⤝" => ArrowOp, "⦷" => ComparisonOp, "⊔" => PlusOp, ">" => ComparisonOp, "⥰" => ArrowOp, "∽" => ComparisonOp, "⋦" => ComparisonOp, "⤅" => ArrowOp, "⫕" => ComparisonOp, "⋺" => ComparisonOp, "∈" => ComparisonOp, "∙" => TimesOp, "⥅" => ArrowOp, "⦼" => TimesOp, "<=" => ComparisonOp, "←" => ArrowOp, "isa" => ComparisonOp, "⋻" => ComparisonOp, "⫔" => ComparisonOp, "⋵" => ComparisonOp, "⋅" => TimesOp, "⨷" => TimesOp, "⟰" => PowerOp, "∨" => PlusOp, "≆" => ComparisonOp, "⪥" => ComparisonOp, "≍" => ComparisonOp, "⪝" => ComparisonOp, "⫂" => ComparisonOp, "⊻=" => AssignmentOp, "⨭" => PlusOp, "⋒" => TimesOp, "⦿" => TimesOp, "≸" => ComparisonOp, "⥡" => PowerOp, "+" => PlusOp, "⇻" => ArrowOp, "⥟" => ArrowOp, "⟉" => ComparisonOp, "⊵" => ComparisonOp, "⩰" => ComparisonOp, "%" => TimesOp, "⫃" => ComparisonOp, "∸" => PlusOp, "⋣" => ComparisonOp, "-->" => ArrowOp, "∥" => ComparisonOp, "∦" => ComparisonOp, "⋮" => ColonOp, "⪒" => ComparisonOp, "⤃" => ArrowOp, "⟑" => TimesOp, "⩑" => TimesOp, "⋰" => ColonOp, "⪬" => ComparisonOp, "≠" => ComparisonOp, "≅" => ComparisonOp, "⊼" => TimesOp, "⬻" => ArrowOp, "⩘" => TimesOp, "⭃" => ArrowOp, "⥭" => ArrowOp, "⤕" => ArrowOp, "≘" => ComparisonOp, "⇠" => 0, "⟺" => ArrowOp, "⪼" => ComparisonOp, "⇢" => 0, "↩" => 0, "⋊" => TimesOp, "&&" => LazyAndOp, "⩚" => TimesOp, "⩮" => ComparisonOp, "⤓" => PowerOp, "⥠" => PowerOp, "⤁" => ArrowOp, "≌" => ComparisonOp, "⭌" => ArrowOp, "⇐" => 0, ":" => ColonOp, "⇍" => 0, "⩭" => ComparisonOp, "↛" => ArrowOp, "↻" => 0, "⪲" => ComparisonOp, "⇔" => ArrowOp, "⪭" => ComparisonOp, "⩱" => ComparisonOp, "⤍" => ArrowOp, "⊃" => ComparisonOp, "∝" => ComparisonOp, "⊊" => ComparisonOp, "⊠" => TimesOp, "∘" => TimesOp, "⇚" => 0, "⪆" => ComparisonOp, "⫋" => ComparisonOp, "|" => PlusOp, "⊉" => ComparisonOp, "∻" => ComparisonOp, "≉" => ComparisonOp, "⩡" => PlusOp, "⨬" => PlusOp, "⩷" => ComparisonOp, ">=" => ComparisonOp, "..." => 0, "where" => WhereOp, "->" => AnonFuncOp, "|=" => AssignmentOp, "'" => PrimeOp, "!" => 0, "√" => 0, "∛" => 0, "∜" => 0, "++" => PlusOp, "¬" => 0)